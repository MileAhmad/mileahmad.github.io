<?php 
	...
	if (isset($_POST["submit"]) ) {
		...
		if(tarik($_POST) > 0) {
			echo "
				<script>
					alert('tabungan berhasil ditarik')
		...
		<div class="main">
			...
			<div class="tambah">
				<form action="" method="POST">
					<ul>
						<li>
							<label for="tgl">Tanggal Ambil : </label><br>
						...
						<li>
							<label for="jmlsetor">Jumlah Ambil : </label><br>
							<input type="text" name="jmltarik" id="jmlambil">
						</li>
						<li>
